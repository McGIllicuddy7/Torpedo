use raylib::{camera::Camera3D, color, ffi::CameraMode, input::key_from_i32, math::Matrix, RaylibHandle, RaylibThread};
...
pub fn handle_player(
    ...
    update_camera(player_data, _thread, handle);
...
pub fn run_game_systems(
    ...
    run_ai();
    run_ships();
    update_camera(player_data, thread, handle);
}
